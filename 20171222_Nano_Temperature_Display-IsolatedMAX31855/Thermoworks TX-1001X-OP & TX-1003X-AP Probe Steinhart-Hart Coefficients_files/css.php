...
.blockhead {
	font:  normal 12px Tahoma, Calibri, Verdana, Geneva, sans-serif;
	color:#3e3e3e;
	background:cccc99 url(images/buttons/newbtn_middle.png) repeat-x  ;
...
.blockhead a:hover { color:#3e3e3e; }
...
.above_body {
	background:#cc6600 none repeat-x  ;
...
.toplinks ul.isuser .notifications .popupbody {
	background: #eeeecc;
	border: 1px solid #eeeecc; /* makes it look consistent with the popup background */
}
...
.toplinks ul.isuser .notifications .popupbody li a{
	...
	padding: 0 5px;
	font-weight: normal;
	border-top:1px solid #eeeecc; /* makes it look consistent with the popup background */
	text-align: left;
	padding-left: 30px;
	line-height: 26px;
}
...
.navbar a { color:#3e3e3e; }
.navbar a:hover { color:#3e3e3e; }

.navtabs {
	background:#eeeecc url(images/buttons/newbtn_middle.png) repeat-x  ;
...
.navtabs li a.navtab:hover {
	background:#cccc99 url(images/gradients/selected-tab-gradient-with-top-alpha.png) repeat-x   0 -4px;
	color:#3e3e3e;
}
...
.navtabs li.selected a.navtab {
	color:#3e3e3e;
	background:#cccc99 url(images/gradients/selected-tab-gradient-with-top-alpha.png) repeat-x  ;
	position:relative;
	top:-4px;
	padding-top:4px;
	z-index:10;
...
.toplinks .notifications a.popupctrl {	
	...
	padding-left: 4px;
	padding-right: 15px;
	background: #3e3e3e url(images/misc/arrow.png) right center no-repeat ;
	-moz-border-radius-bottomleft: 5px;
	-moz-border-radius-bottomright: 5px;
	-webkit-border-bottom-right-radius:5px;
	-webkit-border-bottom-left-radius: 5px;
...
.toplinks .notifications a.popupctrl:hover, .toplinks .nonotifications a.popupctrl:hover, .toplinks .nonotifications a.popupctrl.active , .toplinks .notifications a.popupctrl.active{
	...
	padding-left: 4px;
	padding-right: 15px;
	background: #3e3e3e url(images/misc/arrow.png) no-repeat right center;
}
