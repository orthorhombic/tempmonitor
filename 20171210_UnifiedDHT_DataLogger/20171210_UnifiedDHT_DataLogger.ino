...
//#define DHTTYPE DHT22   // DHT 22  (AM2302), AM2321
DHT dht1(7, DHT22); // what digital pin we're connected to, which sensor type
DHT dht2(9, DHT22);
...
//
//
//Reading values twice in a row quickly leads to data issues!!! 
//Nonsensical values given in log file
//
...
dataString += ", ";     //puts a comma between the two bits of data
//delay(1);
dataString = dataString + String(dht1.readTemperature());
delay(1000);
dataString += ", ";     //puts a comma between the two bits of data
//delay();
...
dataString += ", ";     //puts a comma between the two bits of data
//delay(1);
dataString = dataString + String(dht2.readTemperature());
delay(1000);
dataString += ", ";     //puts a comma between the two bits of data
//delay(1);
...
String dataString1 = ""; //this line simply erases the string
dataString1 += CycleTimeStamp;
//delay(1);
dataString1 += ", ";     //puts a comma between the two bits of data
//delay(1);
dataString1 = dataString1 + String(temp3231);
//delay(1);
dataString1 += ", ";     //puts a comma between the two bits of data
//delay(1);
dataString1 = dataString1 + String(dht1.readTemperature());
delay(1000);
dataString1 += ", ";     //puts a comma between the two bits of data
//delay();
dataString1 = dataString1 + String(dht1.readHumidity());
delay(1000);
dataString1 += ", ";     //puts a comma between the two bits of data
//delay(1);
dataString1 = dataString1 + String(dht2.readTemperature());
delay(1000);
dataString1 += ", ";     //puts a comma between the two bits of data
//delay(1);
dataString1 = dataString1 + String(dht2.readHumidity());
//delay(1);
